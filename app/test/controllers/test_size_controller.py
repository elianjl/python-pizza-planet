...
def test_create_size_controller(app, size: dict):
...
def test_update_size_controller(app, size: dict):
...
def test_get_size_by_id_controller(app, size: dict):
    created_size, _ = SizeController.create(size)
...
def test_get_all_size_controller(app, sizes: list):
    created_sizes = []
    for size in sizes:
        created_size, _ = SizeController.create(size)
